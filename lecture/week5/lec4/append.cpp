...
int main()
{
   ...
   // look at line 80 for append mode
   ...
   // .eof() returns true if we have completed reading all the data in 
    // the file - end of file
   while(!fin.eof()) // as long as there is data to read from file, loop will execute
   {
    ...
    // writes to the file associated with fout here (output.txt)
