...
int main()
{
    ...
    // if (a == 3) {....}
    // The above condition is only true when 'a' is equal to 3

    // This error can also occur with 'char' type variables
    // char c = 'a'
    // if (c = 'b') instead of if (c == 'b')

    int x = 0;

    // If you change this == to =, the program will never enter the
