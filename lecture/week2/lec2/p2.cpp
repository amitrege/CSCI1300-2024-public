...
int main()
{
    ...
    regardless of the option you choose on level 1.
    
    Other problems may have different menus on different levels 
    depending on the option you choose on the previous level.
    ...
    */
    ...
    if (option1 == 1) {
        ...
        if (option2 == 1){
            ...
            // Input validation for option2
            
            // Print this if the user enters a number not in {1,2,3,4}
        ...
        // notice the logic here remains the same from when option1 == 1
        
        // The only thing that changes is we print Aerospace instead of
        // Computer Science in the print statements
        ...
        // Input validation for option1
        
        // Print this if the user enters a number not in {1,2}
        cout << "Invalid input. Choose between values on the screen" << endl;
    }
