...
int main() {
    ...
    // Infact, the 'a' inside the function is a copy of the 'a' outside
    ...
    // of every parameter just to make an update inside a function
   ...
   // NO!
    ...
    cout << endl;
    cout << "The value of \'p\' before update4 is " << k << endl;
    update4(k); // Pass address of a 
    cout << "The value of \'p\' after update4 is " << k << endl;
    ...
    // you have 2 options:
    // 1. Return the value from the function (using the return statement)
    // 2. Pass a pointer to that variable instead of just that variable as the argument
    
    
    
    
    // Obviously option 1 is simpler to understand so why not do it always?
    
    // Because recall a function can only return a single value!
    
    // Think what would happen if you wanted to write a function which changed 2 values 
    // inside instead of just one
    
    // Now we HAVE to pass 2 pointers as arguments
