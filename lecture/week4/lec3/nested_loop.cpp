...
int main() {
    ...
    // We can think of the outer loop as holding one index constant
    ...
    // Obviously there will always be a match found at the same index
    ...
    // Start the second index ahead of the first index 
    for(int i = 0; i < size; i++) {
    ...
    // the last homework (the inner loop becomes smaller depending on
    // the outer loop)
    ...
    // Think of the string as a array of chars.    
}