...
int main(void) {
    // An array is just a contiguous block of locations in memory

    // For example: int a[4] = {1,2,3,4}
    // |__|__|_1|_2|_3|_4|__|__|__|__|__|
    // |__|__|__|__|__|__|__|__|__|__|__|
    
    // Data is stored in the same order as the array and side by side
    ...
    // 2nd element -> *(ptr + 1) (equivalent to a[1])
